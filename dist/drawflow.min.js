export default class Drawflow {
    ...
    addNodeImport (dataNode, precanvas) {
      ...
      if((typeof myVar === 'string' || myVar instanceof String) && dataNode.class != '') {
      ...
      const deleteNode = document.createElement('div');
       (deleteNode.innerHTML = 'x'), deleteNode.setAttribute('id', 'node-' + a + '-delete'), deleteNode.setAttribute('data-id', a), deleteNode.classList.add('drawflow-delete-node');
