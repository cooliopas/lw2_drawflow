            ...
            class i {
                constructor(e, t = null, n = null) {
                    (this.events = {}),
                        ...
                        (this.evCache = []),
                        (this.prevDiff = -1),
                        (this.contentEditableTextMaxLength = 250);
                }
                start() {
                ...
                load() {
                    ...
                    Object.keys(t).map(function (e) {
                        Object.keys(t[e].data).map(function (e) {
                ...
                removeReouteConnectionSelected() {
                    this.dispatch('connectionUnselected', !0),
                        ...
                        this.connection_selected.parentElement.querySelectorAll('.main-path').forEach((e) => {
                ...
                click(e) {
                    ...
                    switch (this.ele_selected.classList[0]) {
                        ...
                        case 'drawflow-delete-node':
                            ...
                            /*/ var r = confirm('Are you sure you want to delete this Plot Point? (' + formatted + ')');
                             if (r == true) {
                                 this.removeNodeId('node-' + this.ele_selected.dataset.id);
                ...
                position(e) {
                    ...
                    if (this.drag_point) {
                        ...
                        const h = e.slice(5),
                            u = this.drawflow.drawflow[this.module].data[h].outputs[d].connections.findIndex(function (e) {
                ...
                dragEnd(e) {
                    ...
                    if (this.drag && ((this.pos_x_start == t && this.pos_y_start == n)) && e.button == 0) {
                            ...
                            n.forEach((t, a) => {
                                if (0 === a && n.length - 1 == 0) {
                                    ...
                                    var C = t.parentElement.classList[1].replace('node_in_', ''),
                                        x = (R = i.querySelector('#' + C)).querySelectorAll('.' + t.parentElement.classList[4])[0];
                                    (g = (E = R.querySelectorAll('.' + t.parentElement.classList[4])[0]).offsetWidth / 2 + (E.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (_ = E.offsetHeight / 2 + (E.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                    ...
                                    (f = t),
                                        (g = ((x = n[a + 1]).getBoundingClientRect().x - s.getBoundingClientRect().x) * (s.clientWidth / (s.clientWidth * h)) + r),
                            ...
                            n.forEach((t, a) => {
                                if (0 === a && n.length - 1 == 0) {
                                    var f = i.querySelector('#' + e),
                                        ...
                                        _ = (R = f.querySelectorAll('.' + t.parentElement.classList[4])[0]).offsetWidth / 2 + (R.getBoundingClientRect().x - s.getBoundingClientRect().x) * u,
                                        w = R.offsetHeight / 2 + (R.getBoundingClientRect().y - s.getBoundingClientRect().y) * p,
                                        v = l(m, g, _, w, d, 'close');
                                    (o += v), h.push(v);
                                    f = t;
                                    var y = t.parentElement.classList[2].replace('node_out_', ''),
                                        C = (L = i.querySelector('#' + y)).querySelectorAll('.' + t.parentElement.classList[3])[0];
                                    (m = (x = L.querySelectorAll('.' + t.parentElement.classList[3])[0]).offsetWidth / 2 + (x.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                    ...
                                    (f = t),
                                        ...
                                        (_ = (R = L.querySelectorAll('.' + t.parentElement.classList[4])[0]).offsetWidth / 2 + (R.getBoundingClientRect().x - s.getBoundingClientRect().x) * u),
                                        (w = R.offsetHeight / 2 + (R.getBoundingClientRect().y - s.getBoundingClientRect().y) * p),
                                        (m = (f.getBoundingClientRect().x - s.getBoundingClientRect().x) * u + r),
                                        (g = (f.getBoundingClientRect().y - s.getBoundingClientRect().y) * p + r),
                                        (v = l(m, g, _, w, d, 'close'));
                ...
                createReroutePoint(e) {
                    ...
                    const r = t.slice(5),
                        h = this.drawflow.drawflow[this.module].data[r].outputs[i].connections.findIndex(function (e) {
                    ...
                    void 0 === this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points && (this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points = []),
                        this.reroute_fix_curvature
                            ? (d > 0
                                ...
                                e.parentElement.querySelectorAll('.main-path').forEach((e) => {
                                    e.classList.remove('selected');
                                }))
                            : this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points.push({ pos_x: l, pos_y: c }),
                ...
                removeReroutePoint(e) {
                    ...
                    const l = t.slice(5),
                        c = this.drawflow.drawflow[this.module].data[l].outputs[i].connections.findIndex(function (e) {
                            return e.node === n && e.output === s;
                        });
                    if (this.reroute_fix_curvature) {
                        const t = e.parentElement.querySelectorAll('.main-path').length;
                ...
                addNode(e, t, n, i, s, o, l, c, d = !1) {
                    ...
                    (x.innerHTML = 'x'), x.setAttribute('id', 'node-' + a + '-delete'), x.setAttribute('data-id', a), x.classList.add('drawflow-delete-node');
                    ...
                    if (l.hasOwnProperty('type')) {
                        ...
                        icon.setAttribute('id', 'icon-node-' + a);
                        icon.setAttribute('data-id', a);
                    ...
                    if ((_.classList.add('drawflow_content_node'), !1 === d)) _.innerHTML = c;
                        ...
                        this.render.createApp({ parent: this.parent, render: () => this.render.h(this.noderegister[c].html, this.noderegister[c].props, this.noderegister[c].options) }).mount(_);
                    } else {
                            ...
                            !(function e(t, n, i) {
                                ...
                                null !== t &&
                                    Object.entries(t).forEach(function (n) {
                                        ...
                                        else for (var o = _.querySelectorAll('[df-' + i + '-' + n[0] + ']'), l = 0; l < o.length; l++) o[l].value = n[1];
                                    });
                            })(null, e[0], e[0]);
                        else for (var n = _.querySelectorAll('[df-' + e[0] + ']'), i = 0; i < n.length; i++) {

                            if (n[i].contentEditable == 'true' || n[i].contentEditable == 'false') {
                                n[i].innerHTML = e[1];
                            }
                            else {
                                n[i].value = e[1];
                ...
                addNodeImport(e, t) {
                    ...
                    (i.innerHTML = ''), i.setAttribute('id', 'node-' + e.id), i.classList.add('drawflow-node'), '' != e.class && !Array.isArray(e.class) && i.classList.add(e.class), '' != e.class && Array.isArray(e.class) && i.classList.add(...e.class);

                    const x = document.createElement('div');
                    (x.innerHTML = '<i class="fa-thin fa-x"></i>'), x.setAttribute('id', 'node-' + e.id + '-delete'), x.setAttribute('data-id', e.id), x.classList.add('drawflow-delete-node');

                    const icon = document.createElement('div');

                    if (e.hasOwnProperty('data') && e.data.hasOwnProperty('type')) {

                        if (e.data.type == 'outline') {
                            icon.innerHTML = '<svg width="29" height="27" viewBox="0 -0.5 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6 4H14" stroke="white" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M6.00037 8H14" stroke="white" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M6.00037 12H14" stroke="white" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M3.25 4.75C3.66421 4.75 4 4.41421 4 4C4 3.58579 3.66421 3.25 3.25 3.25C2.83579 3.25 2.5 3.58579 2.5 4C2.5 4.41421 2.83579 4.75 3.25 4.75Z" fill="white"></path> <path d="M3.25 8.75C3.66421 8.75 4 8.41421 4 8C4 7.58579 3.66421 7.25 3.25 7.25C2.83579 7.25 2.5 7.58579 2.5 8C2.5 8.41421 2.83579 8.75 3.25 8.75Z" fill="white"></path> <path d="M3.25 12.75C3.66421 12.75 4 12.4142 4 12C4 11.5858 3.66421 11.25 3.25 11.25C2.83579 11.25 2.5 11.5858 2.5 12C2.5 12.4142 2.83579 12.75 3.25 12.75Z" fill="white"></path></svg>';
                        }
                        else if (e.data.type == 'chapter') {
                            icon.innerHTML = '<svg width="27" height="27" viewBox="-1 -1.5 17 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M13 14H3.99998C3.86737 14 3.7402 13.9473 3.64643 13.8535C3.55267 13.7598 3.5 13.6326 3.5 13.5V2.5C3.5 2.3674 3.55267 2.24022 3.64643 2.14645C3.7402 2.05268 3.86737 2 3.99998 2H10.0002L13.5 5.5V13.5C13.5 13.6326 13.4473 13.7598 13.3536 13.8535C13.2598 13.9473 13.1326 14 13 14V14Z" stroke="white" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M10 2V5.5H13.5005" stroke="white" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round"></path></svg>';
                        }
                        else if (e.data.type == 'custom') {
                            icon.innerHTML = '<svg width="27" height="28" viewBox="-1.4 -1.5 14 17" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="6.5" cy="7" r="6" stroke="white" stroke-width="0.83"></circle></svg>';
                        }
                        else if (e.data.type == 'character' || e.data.type == 'storyelement') {
                            icon.innerHTML = '<svg width="28" height="28" viewBox="0 -0.8 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.5 14C11.8137 14 14.5 11.3137 14.5 8C14.5 4.68629 11.8137 2 8.5 2C5.18629 2 2.5 4.68629 2.5 8C2.5 11.3137 5.18629 14 8.5 14Z" stroke="white" stroke-width="0.833333" stroke-miterlimit="10"></path> <path d="M8.5 10C9.88071 10 11 8.88071 11 7.5C11 6.11929 9.88071 5 8.5 5C7.11929 5 6 6.11929 6 7.5C6 8.88071 7.11929 10 8.5 10Z" stroke="white" stroke-width="0.833333" stroke-miterlimit="10"></path> <path d="M4.48743 12.4609C4.86406 11.7204 5.43825 11.0986 6.14644 10.6642C6.85464 10.2299 7.66921 10 8.49998 10C9.33075 10 10.1453 10.2299 10.8535 10.6642C11.5617 11.0985 12.1359 11.7204 12.5125 12.4609" stroke="white" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round"></path></svg>';
                        }

                        icon.setAttribute('id', 'icon-node-' + e.id);
                    ...
                    o.classList.add('outputs'),
                        Object.keys(e.inputs).map(function (n) {
                            const cInputDom = document.createElement('div');
                            cInputDom.classList.add('input'),
                                cInputDom.classList.add(n);


                            if (e.inputs[n].connections.length > 0) {
                                cInputDom.classList.add('hasConnection');
                            }

                            s.appendChild(cInputDom);

                            Object.keys(e.inputs[n].connections).map(function (i) {
                    ...
                    Object.keys(e.outputs).map(function (n, l) {
                        const outputDOM = document.createElement('div');
                        outputDOM.classList.add('output'), outputDOM.classList.add('output_' + (l + 1));

                        if (e.outputs[n].connections.length > 0) {
                            outputDOM.classList.add('hasConnection');
                        }
                        o.appendChild(outputDOM);
                    });
                    ...
                    if ((c.classList.add('drawflow_content_node'), !1 === e.typenode)) c.innerHTML = e.html;
                        ...
                        this.render.createApp({ parent: this.parent, render: () => this.render.h(this.noderegister[e.html].html, this.noderegister[e.html].props, this.noderegister[e.html].options) }).mount(c);
                    } else {
                            ...
                            !(function t(n, i, s) {
                                ...
                                null !== n &&
                                    Object.entries(n).forEach(function (e) {
                                        ...
                                        else for (var o = c.querySelectorAll('[df-' + s + '-' + e[0] + ']'), l = 0; l < o.length; l++) o[l].value = e[1];
                                    });
                            })(null, t[0], t[0]);
                        else for (var i = c.querySelectorAll('[df-' + t[0] + ']'), s = 0; s < i.length; s++) {

                            if (i[s].contentEditable == 'true' || i[s].contentEditable == 'false') {
                                i[s].innerHTML = t[1];
                            }
                            else {
                                i[s].value = t[1];
                ...
                addRerouteImport(e) {
                    const t = this.reroute_width,
                        ...
                        i = this.container;
                    Object.keys(e.outputs).map(function (s) {
                        Object.keys(e.outputs[s].connections).map(function (o) {
                ...
                updateNodeDataFromId(e, t, html = null) {
                ...
                removeNodeInput(e, t) {
                    ...
                    if (
                        ...
                        this.container.querySelectorAll('#node-' + e + ' .inputs .input').forEach((e) => {
                ...
                removeNodeOutput(e, t) {
                    ...
                    if (
                        ...
                        this.container.querySelectorAll('#node-' + e + ' .outputs .output').forEach((e) => {
                ...
                removeConnection() {
                    if (null != this.connection_selected) {
                        ...
                        var t = this.drawflow.drawflow[this.module].data[e[2].slice(14)].outputs[e[3]].connections.findIndex(function (t) {
                        ...
                        var n = this.drawflow.drawflow[this.module].data[e[1].slice(13)].inputs[e[4]].connections.findIndex(function (t) {
                ...
                removeSingleConnection(e, t, n, i) {
                    ...
                    if (s === this.getModuleFromNodeId(t)) {
                        if (
                            this.drawflow.drawflow[s].data[e].outputs[n].connections.findIndex(function (e) {
                            ...
                            var o = this.drawflow.drawflow[s].data[e].outputs[n].connections.findIndex(function (e) {
                                return e.node == t && e.output === i;
                            });
                            this.drawflow.drawflow[s].data[e].outputs[n].connections.splice(o, 1);
                            var l = this.drawflow.drawflow[s].data[t].inputs[i].connections.findIndex(function (t) {
                ...
                removeConnectionNodeId(e) {
                    ...
                    for (var s = i.length - 1; s >= 0; s--) {
                        var o = i[s].classList,
                            l = this.drawflow.drawflow[this.module].data[o[1].slice(13)].inputs[o[4]].connections.findIndex(function (e) {
                        ...
                        var c = this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.findIndex(function (e) {
                    ...
                    for (s = d.length - 1; s >= 0; s--) {
                        (o = d[s].classList),
                            (c = this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.findIndex(function (e) {
                                return e.node === o[1].slice(13) && e.output === o[4];
                            }));
                        this.drawflow.drawflow[this.module].data[o[2].slice(14)].outputs[o[3]].connections.splice(c, 1);
                        l = this.drawflow.drawflow[this.module].data[o[1].slice(13)].inputs[o[4]].connections.findIndex(function (e) {
                ...
                getModuleFromNodeId(e) {
                    ...
                    return (
                        Object.keys(n).map(function (i) {
                            Object.keys(n[i].data).map(function (n) {
                                n == e && (t = i);
                            });
                        }),
                        t
